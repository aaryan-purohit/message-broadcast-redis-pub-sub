...
func TestGetEnv_WithDifferentValues(t *testing.T) {
	tests := []struct {
		...
		{"empty string value", "EMPTY", "", "default", "default"},
		{"non-empty value", "REDIS_ADDR", "localhost:6379", "127.0.0.1:6379", "localhost:6379"},
		{"missing key", "MISSING", "", "default-value", "default-value"},
	}
